...
rl.question('What\'s you name? Nicknames are also acceptable :) ', (answer) => {
        ...
        rl.question('What\'s your favourite thing to eat for that meal? ', (answer4) => {
          ...
          rl.question('Which sport is your absolute favourite? ', (answer5) => {
            ...
            rl.question('What is your superpower? In a few words, tell us what you are amazing at! ', (answer6) => {
              ...
              `);
              console.log(`${answer} loves listening to ${answer1} while listening to ${answer2}, devouring ${answer4} for ${answer3}, prefers ${answer5} over any other sport, and is amazing at ${answer6}`);
              rl.close();
            });
          });
        });
